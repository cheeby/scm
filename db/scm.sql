...
--
-- Name: event_categories; Type: TABLE; Schema: public; Owner: maria_montessori; Tablespace: 
--
...
ALTER TABLE public.event_categories OWNER TO maria_montessori;

--
-- Name: event_categories_id_seq; Type: SEQUENCE; Schema: public; Owner: maria_montessori
--
...
ALTER TABLE public.event_categories_id_seq OWNER TO maria_montessori;

--
-- Name: event_categories_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: maria_montessori
--
...
--
-- Name: event_categories_id_seq; Type: SEQUENCE SET; Schema: public; Owner: maria_montessori
--

SELECT pg_catalog.setval('event_categories_id_seq', 2, true);


--
-- Name: events; Type: TABLE; Schema: public; Owner: maria_montessori; Tablespace: 
--
...
ALTER TABLE public.events OWNER TO maria_montessori;

--
-- Name: events_id_seq; Type: SEQUENCE; Schema: public; Owner: maria_montessori
--
...
ALTER TABLE public.events_id_seq OWNER TO maria_montessori;

--
-- Name: events_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: maria_montessori
--
...
--
-- Name: events_id_seq; Type: SEQUENCE SET; Schema: public; Owner: maria_montessori
--
...
--
-- Data for Name: event_categories; Type: TABLE DATA; Schema: public; Owner: maria_montessori
--

COPY event_categories (id, name, active, created_at, updated_at) FROM stdin;
1	No School	t	2013-01-04 18:36:17.895544	2013-01-04 18:36:17.895544
2	Early Release	t	2013-01-04 18:36:32.115276	2013-01-04 18:36:32.115276
\.


--
-- Data for Name: events; Type: TABLE DATA; Schema: public; Owner: maria_montessori
--

COPY events (id, category_id, name, description, location, active, created_at, updated_at, slug, starts_at, ends_at) FROM stdin;
\.
...
--
-- Name: event_categories_pkey; Type: CONSTRAINT; Schema: public; Owner: maria_montessori; Tablespace: 
--
...
--
-- Name: events_pkey; Type: CONSTRAINT; Schema: public; Owner: maria_montessori; Tablespace: 
--
...
--
-- Name: index_events_on_slug; Type: INDEX; Schema: public; Owner: maria_montessori; Tablespace: 
--
